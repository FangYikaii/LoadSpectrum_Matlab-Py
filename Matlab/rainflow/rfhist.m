...
%         [no,xo]=rfhist(rf,30);
%
% 输入: rf  【雨流计数结果】   - rainflow data from rainflow function,
%                 see RAINFLOW for more details,
%        x  【分割区间】    - when x is a scalar, uses x bins or when
...
%                 extracted cycles.
%
% Output: no - vector, number of extracted cycles,【循环次数】
%         xo - vector, bin locations.
%
% See also: HIST, RAINFLOW, RFMATRIX.

% By Adam Nies硂ny, 10-Aug-2003
% Revised, 10-Nov-2009
