function [x_ampl,y_ampl,x_mean,y_mean,m_matrix,x_matrix,y_matrix]=rainflowx(ext)
...
ext=sig2ext(ext);
rf=rainflow(ext);
[x_ampl,y_ampl]= rfhist(rf,60,'ampl');
[x_mean,y_mean]=rfhist(rf,60,'mean');
[m_matrix,x_matrix,y_matrix]=rfmatrix(rf,30,30);
% figure();
% rfhist(rf,30,'ampl');
% figure();
% rfhist(rf,30,'mean');
